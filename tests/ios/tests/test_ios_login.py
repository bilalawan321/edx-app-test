...
class TestIosLogin:
    ...
    def test_start_login_smoke(self, ios_driver, setup_logging):
        """
        Scenario:
    ...
    def test_load_agreement_smoke(self, ios_driver, setup_logging):
        """
        Scenarios:
    ...
    def test_forgot_password_alert_smoke(self, ios_driver, setup_logging):
        """
        Scenarios:
    ...
    def test_login_smoke(self, ios_driver, setup_logging):
        """
        Scenario:
    ...
    def test_landscape_smoke(self, ios_driver, setup_logging):
        ...
        global_contents.scroll_from_element(ios_driver, ios_login_page.get_forgot_password_textview())
        assert ios_login_page.get_sign_in_button().text == strings.LOGIN
        assert ios_login_page.get_login_with_email_divider_textview().text == strings.LOGIN_IOS_WITH_EMAIL_DIVIDER
        assert ios_login_page.get_facebook_textview().text == strings.LOGIN_FACEBOOK_OPTION
        assert ios_login_page.get_google_textview().text == strings.LOGIN_GOOGLE_OPTION
