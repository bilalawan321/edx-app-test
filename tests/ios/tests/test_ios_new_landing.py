...
class TestIosNewLanding:
    ...
    def test_start_new_landing_smoke(self, ios_driver, setup_logging):
        """
        Scenarios:
        ...
        ios_new_landing = IosNewLanding(ios_driver, setup_logging)
    ...
    def test_search_courses_smoke(self, ios_driver, setup_logging):
        """
