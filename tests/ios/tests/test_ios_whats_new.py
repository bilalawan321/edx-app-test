...
class TestIosWhatsNew:
    ...
    def test_start_whats_new_smoke(self, login, setup_logging, ios_driver):
        """
        Scenarios:
        ...
        if global_contents.is_first_time:
            assert IosWhatsNew(ios_driver, setup_logging).get_title_textview()
        else:
            textview_screen_title = IosMainDashboard(ios_driver, setup_logging)
    ...
    def test_navigate_features_smoke(self, ios_driver, setup_logging):
        """
    ...
    def test_close_features_screen_smoke(self, ios_driver, setup_logging):
        """
    ...
    def test_re_login_smoke(self, setup_logging, ios_driver):
        """
        Scenarios:
